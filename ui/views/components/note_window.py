from PySide6.QtWidgets import (
    ...
    QTextEdit, QLabel, QWidget, QMenu, QFontComboBox,
    QSpinBox, QColorDialog, QToolBar, QComboBox,
    QCheckBox, QFrame, QScrollArea, QToolButton
)
from PySide6.QtCore import Qt, QPoint, QSize
from PySide6.QtGui import QFont, QTextCharFormat, QColor, QIcon, QAction, QTextListFormat, QTextBlockFormat, QTextFormat, QTextCursor
...
class popup_notewindow(QDialog):
    ...
    def showContextMenu(self, position):
        ...
        for block_type in ["Text", "Heading 1", "Heading 2", "Heading 3", "To-do", "Callout", "Quote"]:
        ...
        for display_name, font_name in common_fonts:
            ...
            action.triggered.connect(lambda checked, f=font_name: self.setFontFamily(QFont(f)))
    ...
    def setBold(self):
        self.content_input.setFontWeight(QFont.Bold if self.content_input.fontWeight() == QFont.Normal else QFont.Normal)
