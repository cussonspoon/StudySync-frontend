...
class QuizService:
    ...
    def create_question(self, question: Question) -> Question:
        ...
        response = requests.post(f"{API_BASE_URL}/question", json={"question": question})
        question = response.json()
        return Question(**question)

    def create_choice(self, question_id: str, choice: Choice) -> Choice:
        """Create a new choice"""
        response = requests.post(f"{API_BASE_URL}/choice", json={"question_id": question_id, "choice": choice})
    ...
    def create_quiz(self, title: str) -> Quiz:
        ...
        response = requests.post(f"{API_BASE_URL}/quiz", json={"title": title})
        quiz = response.json()
    ...
    def update_quiz(self, quiz_id: int, title: Optional[str] = None,
                   description: Optional[str] = None, time_limit: Optional[int] = None,
                   passing_score: Optional[float] = None) -> Optional[Quiz]:
